...
class TriggerActionController extends Controller
{
    ...
    public function update(UpdateTriggerActionRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return response()->updated(__('core::messages.resource.updated', ['model' => 'Trigger Action']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return response()->deleted(__('core::messages.resource.deleted', ['model' => 'Trigger Action']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return response()->restored(__('core::messages.resource.restored', ['model' => 'Trigger Action']));
    ...
    public function export(IndexTriggerActionRequest $request): JsonResponse
    {
        try {
            ...
            return response()->exported(__('core::messages.resource.exported', ['model' => 'Trigger Action']));
