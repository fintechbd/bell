...
class TriggerRecipientController extends Controller
{
    ...
    public function update(UpdateTriggerRecipientRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return response()->updated(__('core::messages.resource.updated', ['model' => 'Trigger Recipient']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return response()->deleted(__('core::messages.resource.deleted', ['model' => 'Trigger Recipient']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return response()->restored(__('core::messages.resource.restored', ['model' => 'Trigger Recipient']));
    ...
    public function export(IndexTriggerRecipientRequest $request): JsonResponse
    {
        try {
            ...
            return response()->exported(__('core::messages.resource.exported', ['model' => 'Trigger Recipient']));
